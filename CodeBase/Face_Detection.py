...
# read input image
img = cv2.imread(r"C:\Users\Nishanth\Documents\Pictures\Face_Detection.jpg")

# convert the image to grayscale
gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)                

# read haar cascade for face detection
face_cascade = cv2.CascadeClassifier(r"C:\Users\Nishanth\Documents\Image Processing\Library\haarcascade_frontalface_default.xml")

# read haar cascade for smile detection
smile_cascade = cv2.CascadeClassifier(r"C:\Users\Nishanth\Documents\Image Processing\Library\haarcascade_smile.xml")
