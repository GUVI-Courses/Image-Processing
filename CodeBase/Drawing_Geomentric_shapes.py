...
#img4 = cv2.line(img4,(0,0),(img4.shape[1],img4.shape[0]),(0,255,0),7) # width & height of img4
...
# Circle
#img6= cv2.circle(img2,(400,60),35,(255,0,255),6)

#Ellipse
#img= cv2.ellipse(img(270,450),(100,50),45,130,270,(255,255,0),1)

# Putting Text
img8 = cv2.putText(img,"Hello World",(300,100),cv2.FONT_HERSHEY_COMPLEX,2,(250,200,100),3)
